...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="p-6">
      ...
      {!kpis && <p className="text-gray-500">Cargando...</p>}
      ...
      {kpis && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{kpis.totalMotos}</div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{kpis.totalContratos}</div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{kpis.pagosPendientes}</div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{kpis.alertasNoLeidas}</div>
            </CardContent>
          </Card>
        </div>
      )}
